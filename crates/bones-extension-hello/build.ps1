...
# engine, and assembles a runnable dist/hello/ next to it. Run with:
# pwsh build.ps1
...
Write-Host "Built: target/wasm32-wasip2/release/bones_extension_hello.wasm"
...
Copy-Item "$PSScriptRoot/target/wasm32-wasip2/release/bones_extension_hello.wasm" "$dist/extensions/bones_extension_hello.wasm"

Write-Host ""
Write-Host "Packaged: $dist/$exeName (extensions/bones_extension_hello.wasm alongside it)"
